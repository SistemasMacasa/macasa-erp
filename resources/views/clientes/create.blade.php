                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div id="telefonos-cel-wrapper"> {{-- ⬅️ NUEVO --}}
                                ...
                                <div class="row">
                                    {{-- Teléfonos fijos --}}
                                    <div class="col-md-4" id="telefonos-col" style="padding-right: 0 !important;">
                                        <div class="mb-2 telefono-item">
                                            ...
                                            <div class="input-group input-group-separated">
                                                ...
                                                <input type="text" name="contacto[0][ext1]"
                                                    class="form-control ext-field div-10ch" placeholder="Ext." maxlength="7">
                                                <button type="button"
                                    ...
                                    <div class="col campo-dato-secundario" id="celulares-col">
                                        <div class="mb-2 celular-item">
                                            ...
                                            <div class="input-group input-group-separated">
                                                <input type="text" name="contacto[0][celular1]" class="form-control phone-field"
                                                    placeholder="Celular" style="min-width: 16ch; max-width: 16ch;">
                                                <button type="button"
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input name="nombre" type="text" id="nombre" class="form-control guarda-mayus"
                                        value="{{ old('nombre') }}" required minlength="3" maxlength="40">
                                    @error('nombre')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input name="apellido_p" type="text" id="apellido_p" class="form-control guarda-mayus"
                                        value="{{ old('apellido_p') }}" required minlength="3" maxlength="27">
                                    @error('apellido_p')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input name="apellido_m" type="text" id="apellido_m" class="form-control guarda-mayus"
                                        value="{{ old('apellido_m') }}" required minlength="3" maxlength="27">
                                    @error('apellido_m')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="genero" id="genero" class="form-select" required>
                                        ...
                                        <option value="no-especificado" @selected(old('genero') == 'no-especificado')>No
                                            Especificado
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-2 telefono-item">
                                            ...
                                            <div class="input-group input-group-separated">
                                                <input name="contacto[0][telefono1]" type="text"
                                                    class="form-control phone-field" value="{{ old('contacto.0.telefono1') }}"
                                                    placeholder="Teléfono" style="min-width: 16ch; max-width: 16ch;" required>
                                                @error('contacto.0.telefono1')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                                <input name="contacto[0][ext1]" type="text"
                                                    class="form-control ext-field div-10ch" value="{{ old('contacto.0.ext1') }}"
                                    ...
                                    <div class="col-md-4" id="celulares-col">
                                        <div class="mb-2 celular-item">
                                            <label class="text-normal">Teléfono Celular 1</label>
                                            <div class="input-group input-group-separated">
                                                <input name="contacto[0][celular1]" type="text" class="form-control phone-field"
