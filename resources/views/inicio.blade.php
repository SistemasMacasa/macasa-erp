        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Alcance Cotizado</span>
                        <h4 class="mb-3">
                ...
                <div class="text-nowrap">
                    ...
                    <span class="ms-1 text-muted font-size-13">Desde la semana pasada</span>
                </div>
            </div><!-- end card body -->
        </div><!-- end card -->
    </div><!-- end col -->
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Total de Cotizaciones</span>
                        <h4 class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Alcance Facturado</span>
                        <h4 class="mb-3">
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">% Alcance de Pedidos</span>
                        <h4 class="mb-3">
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center mb-4">
                    <h5 class="card-title me-2">¿Cómo vamos?</h5>
                    <div class="ms-auto">
                        <div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm align-self-center">
                        <div class="mt-4 mt-sm-0">
                            <div>
                                <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-success"></i> Cotizaciones</p>
                                <h6>5 Elementos = <span class="text-muted font-size-14 fw-normal">$ 40025.32</span></h6>
                            </div>

                            <div class="mt-4 pt-2">
                                <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-primary"></i> Pedidos</p>
                                <h6>4 Elementos = <span class="text-muted font-size-14 fw-normal">$ 100123.64</span></h6>
                            </div>

                            <div class="mt-4 pt-2">
                                <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-info"></i> Cancelado</p>
                                <h6>0 Elementos = <span class="text-muted font-size-14 fw-normal">$ 00.00</span></h6>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-8">
                ...
                <div class="card card-h-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap align-items-center mb-4">
                            <h5 class="card-title me-2">Alcance Facturado</h5>
                            <div class="ms-auto">
                                <select class="form-select form-select-sm">
                                    ...
                                    <option value="JA">Enero</option>
                                    <option value="DE">Diciembre</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm align-self-center">
                                <div class="mt-4 mt-sm-0">
                                    <p class="mb-1">Facturado al día de hoy:</p>
                                    <h4>$ 6134.39</h4>
                                    ...
                                    <div class="row g-0">
                                        <div class="col-6">
                                            <div>
                                                <p class="mb-2 text-muted text-uppercase font-size-11">Score:</p>
                                                <h5 class="fw-medium">$ 2632.46</h5>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div>
                                                <p class="mb-2 text-muted text-uppercase font-size-11">Por facturar:</p>
                                                <h5 class="fw-medium">$ 90024.38</h5>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="mt-2">
                                        <a href="#" class="btn btn-primary btn-sm">Ver más <i class="mdi mdi-arrow-right ms-1"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="carousel-item active">
                                    <div class="text-center p-4">
                                        <div class="avatar-md m-auto">
                                            <span class="avatar-title rounded-circle bg-white text-primary font-size-24 shadow">
                                                <i class="mdi mdi-bullhorn"></i>
                                            </span>
                                        </div>
                                        <h4 class="mt-3 lh-base fw-semibold text-white"><b>Comunicados</b></h4>
                                        <p class="text-white-50 font-size-13">
                                            Mañana evento de MACASA. Por favor, portar la camiseta institucional.
                                        </p>
                                        <button type="button" class="btn btn-outline-light btn-sm text-white-50">Entendido</button>
                                    </div>
                                </div>
    ...
    <div class="col-xl-4">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Mis 5 Mejores</h4>
                <div class="flex-shrink-0">
                    <ul class="nav nav-tabs-custom card-header-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#buy-tab" role="tab">Cotización</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#sell-tab" role="tab">Pedidos</a>
                        </li>
                    </ul>
                </div>
            </div><!-- end card header -->
